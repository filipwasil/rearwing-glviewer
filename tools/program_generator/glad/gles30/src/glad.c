/*
    ...
    OpenGL ES loader generated by glad 0.1.28 on Sun Dec  9 14:43:43 2018.
    ...
    Commandline:
        --profile="core" --api="gles2=3.0" --generator="c" --spec="gl" --extensions="GL_ARM_mali_program_binary,GL_EXT_texture_compression_s3tc,GL_IMG_program_binary,GL_MESA_program_binary_formats,GL_OES_get_program_binary"
    Online:
        https://glad.dav1d.de/#profile=core&language=c&specification=gl&loader=on&api=gles2%3D3.0&extensions=GL_ARM_mali_program_binary&extensions=GL_EXT_texture_compression_s3tc&extensions=GL_IMG_program_binary&extensions=GL_MESA_program_binary_formats&extensions=GL_OES_get_program_binary
*/
