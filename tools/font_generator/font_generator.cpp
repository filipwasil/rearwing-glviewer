...
int FontGenerator::generate(const char* ttfFilePath, const char* outputPNG, const char* outputMETADATA) {
	...
	if (fpMeta) {
		...
		if (fpPng) {
			fclose (fpPng);
			std::cout << ttfFilePath << " font already generated\n";
			return 0;
		}
	}
	...
	std::cout << outputPNG << " font atlas generated\n";
	std::cout << outputMETADATA << " font metadata generated\n";
	return 0;
}
